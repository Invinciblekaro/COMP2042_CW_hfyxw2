...
public class LevelCell extends ListCell<Level> {
    ...
    protected void updateItem(Level item, boolean empty) {
        ...
        if (!empty) {
            ...
            switch (difficulty) {
                case 1:
                    shieldIcon = Tool.loadImage("misc/shield-easy.png");
                    break;
                case 2:
                    shieldIcon = Tool.loadImage("misc/shield-medium.png");
                    break;
                case 3:
                    shieldIcon = Tool.loadImage("misc/shield-hard.png");
                    break;
                default:
                    shieldIcon = Tool.loadImage("misc/shield.png");
                    break;
            }
